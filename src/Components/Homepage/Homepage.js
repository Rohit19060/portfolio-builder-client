    ...
    return (
      <>
        ...
        <div className="main_div">
          <h1 className="text-center title">Time to make your Portfolio</h1>
          ...
          <div className="sub_buttons">
            <Link to="/get-started" className="getstarted text-center">
              Get Started
            </Link>
            <Link to="/howtouse" className="getstarted text-center">
              How to use it
            </Link>
          </div>
        </div>
